...
fizzy -l SEX -f MIM -i ${path_data}/AmericanGut-Gut-Sex.biom  \
  -m ${path_data}/AmericanGut-Gut-Sex.txt \
...
fizzy -l SEX -f JMI -i ${path_data}/AmericanGut-Gut-Sex.biom \
  -m ${path_data}/AmericanGut-Gut-Sex.txt \
...
npfs -l SEX -f MIM -i ${path_data}/AmericanGut-Gut-Sex.biom \
  -m ${path_data}/AmericanGut-Gut-Sex.txt -o tmp.txt \
...
npfs -l SEX -f JMI -i ${path_data}/AmericanGut-Gut-Sex.biom \
  -m ${path_data}/AmericanGut-Gut-Sex.txt -o tmp.txt -n ${nsel} \
...
lasso -l SEX -i ${path_data}/AmericanGut-Gut-Sex.biom -m ${path_data}/AmericanGut-Gut-Sex.txt -q outputs/AmericanGut-Gut-Sex-lasso-weights.txt -o outputs/AmericanGut-Gut-Sex-lasso-out.txt -r outputs/AmericanGut-Gut-Sex-lasso.biom -c lasso_config.txt

###############################################################################
###############################################################################
###############################################################################
echo "Running MIM; AG-DIET"
fizzy -l DIET_TYPE -f MIM -i ${path_data}/AmericanGut-Gut-Diet-OmniVegan.biom \
  -m ${path_data}/AmericanGut-Gut-Diet-OmniVegan.txt \
...
fizzy -l DIET_TYPE -f JMI -i ${path_data}/AmericanGut-Gut-Diet-OmniVegan.biom \
  -m ${path_data}/AmericanGut-Gut-Diet-OmniVegan.txt \
...
npfs -l DIET_TYPE -f MIM \
  -i ${path_data}/AmericanGut-Gut-Diet-OmniVegan.biom \
  -m ${path_data}/AmericanGut-Gut-Diet-OmniVegan.txt -o tmp.txt \
...
lasso -l DIET_TYPE -i ${path_data}/AmericanGut-Gut-Diet-OmniVegan.biom -m ${path_data}/AmericanGut-Gut-Diet-OmniVegan.txt -q outputs/AmericanGut-Gut-Diet-OmniVegan-lasso-weights.txt -o outputs/AmericanGut-Gut-Diet-OmniVegan-lasso-out.txt -r outputs/AmericanGut-Gut-Diet-OmniVegan-lasso.biom -c lasso_config.txt

###############################################################################
###############################################################################
###############################################################################
echo "Running MIM; Caporaso-Sex"
fizzy -l SEX -f MIM -i ${path_data}/caporaso-gut.biom \
  -m ${path_data}/caporaso-gut.txt -o outputs/caporaso-gut-Results-Fizzy-MIM.txt \
  -n ${nsel} -r outputs/caporaso-gut-Results-Fizzy-MIM.biom

echo "Running JMI; Caporaso-Sex"
fizzy -l SEX -f JMI -i ${path_data}/caporaso-gut.biom \
  -m ${path_data}/caporaso-gut.txt \
...
npfs -l SEX -f MIM -i ${path_data}/caporaso-gut.biom \
  -m ${path_data}/caporaso-gut.txt -o tmp.txt -n ${nsel} -c ${cores} \
...
npfs -l SEX -f JMI -i ${path_data}/caporaso-gut.biom \
  -m ${path_data}/caporaso-gut.txt -o tmp.txt \
...
lasso -l SEX -i ${path_data}/caporaso-gut.biom -m ${path_data}/caporaso-gut.txt -q outputs/caporaso-gut-lasso-weights.txt -o outputs/caporaso-git-lasso-out.txt -r outputs/caporaso-gut--lasso.biom -c lasso_config.txt
...
###############################################################################
echo "Running MIM; AG-DIET"
fizzy -l DIET_TYPE -f MIM -i ${path_data}/AmericanGut-Gut-Diet.biom \
  -m ${path_data}/AmericanGut-Gut-Diet-OV.txt \
  -o outputs/AmericanGut-Gut-Diet-OV-Results-Fizzy-MIM.txt -n ${nsel} \
  -r outputs/AmericanGut-Gut-Diet-OV-Results-Fizzy-MIM.biom

echo "Running JMI; AG-DIET"
fizzy -l DIET_TYPE -f JMI -i ${path_data}/AmericanGut-Gut-Diet.biom \
  -m ${path_data}/AmericanGut-Gut-Diet-OV.txt \
...
echo "Running NPFS-MIM; AG-DIET"
npfs -l DIET_TYPE -f MIM \
  -i ${path_data}/AmericanGut-Gut-Diet.biom \
  -m ${path_data}/AmericanGut-Gut-Diet-OV.txt -o tmp.txt \
...
supervised_learning.py -i ${path_data}/AmericanGut-Gut-Diet.biom -m ${path_data}/AmericanGut-Gut-Diet-OV.txt -o outputs/AmericanGut-Gut-Diet-OV-Results-RF/ -c DIET_TYPE -f 

lasso -l DIET_TYPE -i ${path_data}/AmericanGut-Gut-Diet.biom -m ${path_data}/AmericanGut-Gut-Diet-OV.txt -q outputs/AmericanGut-Gut-Diet-OV-lasso-weights.txt -o outputs/AmericanGut-Gut-Diet-OV-lasso-out.txt -r outputs/AmericanGut-Gut-Diet-OV-lasso.biom -c lasso_config.txt
